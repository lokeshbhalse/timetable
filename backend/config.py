# backend/config.py - SQLite Version
import os
...
class Config:
    ...
    DB_PATH = os.getenv("DB_PATH", os.path.join(ROOT_DIR, "sgsits_timetable.db"))
    
    # JWT
    SECRET_KEY = os.getenv("SECRET_KEY", "your-super-secret-key-for-sgsits-2024-32chars")
